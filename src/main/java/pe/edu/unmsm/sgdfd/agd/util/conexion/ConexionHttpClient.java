...
public class ConexionHttpClient {
    ...
    public DataGeneracionMasivaTO recopilarDataDummy(SolicitudMasivaDocumentoTO solicitud, WebSocket websocket){
	    ...
	    //headers.set("Authorization", "Bearer "+solicitud.getToken());
            ...
            DataGeneracionMasivaTO response = restTemplate.postForObject("https://servicioonline.unmsm.edu.pe/sgdfd/mcc/backend" + "/documentos-generacion/preprocesar/dummy", request, DataGeneracionMasivaTO.class);
    ...
    public DocumentoDummyTO guardarDocumentosDummy(DocumentoDummyTO solicitud, WebSocket websocket){
        try {
            ...
            DocumentoDummyTO response = restTemplate.postForObject("https://servicioonline.unmsm.edu.pe/sgdfd/mcc/backend" + "/documentos-generacion/guardar/dummy", request, DocumentoDummyTO.class);
